...
class IIncomingLoan(form.Schema):
    ...
    model.fieldset('loan_request', label=_(u'Loan Request'), 
        fields=['loanRequest_general_loanNumber',
                'loanRequest_general_lender', 'loanRequest_general_contact',
    ...
    loanRequest_general_lender = RelationList(
        title=_(u'Lender'),
        default=[],
        missing_value=[],
    ...
    contract_contractDetails_notes = ListField(title=_(u'label_notes', default=u'Notes'),
        value_type=DictRow(title=_(u'label_notes', default=u'Notes'), schema=INotesOp),
        required=False)
...
# # # # # # # # # # # # # # #
# Incomingloan declaration  #
# # # # # # # # # # # # # # #

class IncomingLoan(Container):
    grok.implements(IIncomingLoan)
    pass

# # # # # # # # # # # # # # # # # 
# Incomingloan add/edit views   # 
# # # # # # # # # # # # # # # # #

class AddForm(add.DefaultAddForm):
    template = ViewPageTemplateFile('incomingLoan_templates/add.pt')
    def update(self):
...
class EditForm(edit.DefaultEditForm):
    template = ViewPageTemplateFile('incomingLoan_templates/edit.pt')
